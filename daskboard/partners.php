                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Type</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Location</td>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Application date
                                        </td>
