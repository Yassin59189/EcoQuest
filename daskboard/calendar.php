...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                ...
                <a href="calendar.php" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                    <i class="fas fa-calendar mr-3"></i>
                    Calendar
                </a>
                            ...
                            <div style=" background-color: rgba(0, 0, 0, 0.8)"
                                ...
                                <div
                                    ...
                                    <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
                                        ...
                                        <h2 class="font-bold text-2xl mb-6 text-gray-800 border-b pb-2">Add Event
                                            Details</h2>
    ...
    <script>
        ...
        const fetchedEvents = <?php echo json_encode($events);  ?>;
        var eventsList = [];
        for(let i=0; i<fetchedEvents.length ; i++) {
                eventsList.push({event_date:fetchedEvents[i].Date, event_title: fetchedEvents[i].Nom, event_theme: 'blue'})
                }
